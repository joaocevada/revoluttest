...
class CurrenciesAdapter(
    ...
    private val onChangedBase: (base: String) -> Unit
) :
    ListRecyclerAdapter<ExchangeItem, CurrencyExchangeItemBinding>() {
    override val differ: AsyncListDiffer<ExchangeItem> =
        AsyncListDiffer(this, ItemDiffCallback())

    override fun bind(binding: CurrencyExchangeItemBinding, item: ExchangeItem, position: Int) {
        ...
        binding.root.tag = item.currencyCode
    }
    ...
    override fun createBinding(parent: ViewGroup): CurrencyExchangeItemBinding {
        ...
        return DataBindingUtil.inflate<CurrencyExchangeItemBinding>(
            ...
            root.setOnClickListener {
                onChangedBase(it.tag as String)
            }
        }
    }
